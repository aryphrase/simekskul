...
<div class="wrapper">
	...
	<div id="content">
        ...
        <h2>Daftar Rincian Ekstrakurikuler Pramuka</h2>
        <hr>
        <h3>Pemasukan</h3>
        ...
        <div style="overflow-x: auto;width: 50%;">
        	<table>
        		...
        		<tr>
        			<td>Jumlah Pemasukan dari Sponsor</td>
        			<td>Rp 0</td>
        		</tr>
        		<tr>
        			<td>Jumlah Pemasukan dari Hibah</td>
        			<td>Rp 0</td>
        		</tr>
        		<tr>
        			<td>Jumlah Pemasukan dari CSR</td>
        			<td>Rp 0</td>
        		</tr>
        		<tr>
        			<td>Jumlah Pemasukan dari Dana Usaha Mandiri</td>
        			<td>Rp 0</td>
        		</tr>
        		<tr>
        			<td>Jumlah Pemasukan dari Pinjaman bank</td>
        			<td>Rp 0</td>
        		</tr>
        	</table>
        </div>
        ...
        <div style="overflow-x: auto;width: 50%;">
        	<table>
        		...
        		<tr>
        			<td>Total Pengeluaran untuk pembayaran</td>
        			<td>Rp 200.000</td>
        		</tr>
        	</table>
        </div>
