...
<div class="wrapper">
	...
	<div id="content">
        ...
        <hr>
        <form class="edit-form" action="/penilaian/<?php echo e($penilaian->id_penilaian); ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
        	<div class="form-group">
                ...
                <select id="nilai_id" name="nilai_id" >
                    ...
                    <option value="<?php echo e($nilai->id_nilai); ?>"<?php echo e($selected_nilai == $nilai->id_nilai ? 'selected="selected"' : ''); ?>><?php echo e($nilai->nama_nilai); ?></option>
