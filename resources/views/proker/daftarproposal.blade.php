       ...
       <div style="overflow-x: auto;">
            <table>
                ...
                <tr>
                    ...
                    <td>a</td>
                    <td width="5%">{{ link_to_route('proposal.cetakpdfsatuan', 'PDF',[$proposal->id_proposal],['class'=>'btn btn-primary btn-md']) }}
                    </td>
                    @if($jenis == 2)
                    <td width="5%">
                        {{ link_to_route('proposal.edit','Edit',[$proposal->id_proposal],['class'=>'btn btn-primary btn-md']) }}
                    </td>
                    <td width="5%">
