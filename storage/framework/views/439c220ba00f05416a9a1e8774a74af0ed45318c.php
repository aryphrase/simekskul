...
<script type="text/javascript">
	...
	function drawChart() {
		var record=<?php echo json_encode($jenis_ekskul); ?>;
        console.log(record);
...
<script type="text/javascript">
	...
	google.charts.setOnLoadCallback(drawChart);
	function drawChart() {
		var record=<?php echo json_encode($jumlah_anggota); ?>;
        console.log(record);
		var data = new google.visualization.DataTable;
...
<script type="text/javascript">
	...
	google.charts.setOnLoadCallback(drawChart);
	function drawChart() {
		var record=<?php echo json_encode($jumlah_proker1); ?>;
        console.log(record);
		var data = new google.visualization.DataTable;
		...
		var chart = new google.visualization.ColumnChart(document.getElementById('chart_jenisproker'));
		chart.draw(data, options);
	}
</script>