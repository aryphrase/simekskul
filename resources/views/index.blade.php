	...
	<div class="container">
		<div class="row">
			<div class="col col-md-6">
				<img class="web-illustration" src="{{ URL::asset('assets/images/ilustration.png') }}" / alt="">
			</div>
			<div class="col col-md-6">
				<div class="caption">
...
<div id="kategori" style="background-color:white;text-align:center;padding:50px 80px;">
	<div class="photo-grid">
			<div class="row">
				...
				<div class="col col-md-12">
					<p style="text-align:right;font-size:16px;padding-bottom:3px;color:#888;"><a href="{{ URL::to('ekstrakurikuler') }}">Lihat Selengkapnya</a></p>
				</div>
...
<div id="informasi">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-4">
			    <div class="card">
				  	<img src="{{ URL::asset('assets/images/park.jpg') }}" style="width:100%">
			...
			<div class="col-lg-4">
			    <div class="card">
				  	<img src="{{ URL::asset('assets/images/rails.jpg') }}" style="width:100%">
				  	<div class="imagcaption">
				    	<p>Pramuka</p>
			...
			<div class="col-lg-4">
			    <div class="card">
				  	<img src="{{ URL::asset('assets/images/bridge.jpg') }}" style="width:100%">
				  	<div class="imagcaption">
				    	<p>Rohis</p>
			 ...
			 <div class="col-lg-4">
			    <div class="card">
				  	<img src="{{ URL::asset('assets/images/traffic.jpg') }}" style="width:100%">
				  	<div class="imagcaption">
				  		<p>OSIS</p>
				    	<h4><b>Lomba Cerdas Cermat se-Kota Surakarta</b></h4> 
				    	<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </p> 
