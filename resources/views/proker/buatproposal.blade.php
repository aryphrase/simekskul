...
<div class="wrapper">
	...
	<div id="content">
        ...
        <hr>
        <form class="edit-form" action="{{url('/inputdataproposal')}}" method="post" enctype="multipart/form-data" accept-charset="utf-8">
            ...
            @foreach($ekskul2 as $ekskul2)
            <input type="hidden" name="ekskul_id" value="{{$ekskul2->id_ekskul}}">
            @endforeach
