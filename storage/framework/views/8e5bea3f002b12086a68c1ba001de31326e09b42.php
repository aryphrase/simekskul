...
<div class="wrapper">
	...
	<div id="content">
        ...
        <hr>
        <form class="edit-form" action="<?php echo e(url('/inputdatapembina')); ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
        	...
        	<div class="form-group<?php echo e($errors->has('nama_pembina') ? 'has-error' : ''); ?>">
        		<label for="nama_pembina">Nama</label><br>
        		<input type="text" id="nama_pembina" name="nama_pembina" value="<?php echo e($name); ?>"/>
                <span class="text-danger"><?php echo e($errors->first('nama_pembina')); ?></span>
        	</div>
            <div class="form-group<?php echo e($errors->has('foto_pembina') ? 'has-error' : ''); ?>">
